...
help () {
    ...
    OPTIONS:
        -h | -?     this help
        -b          length of ffdhe group to use in bits
                    possible values: 2048, 3072, 4096 (default), 6144, 8192
        -o          path of output file (default for 4096: "ffdhe4096.pem")
